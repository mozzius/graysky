...
import { useSmoothKeyboardHandler } from "./smooth-keyboard-handler";

// taken from here: https://github.com/kirillzyusko/react-native-keyboard-controller/blob/main/example/src/components/AwareScrollView/KeyboardAwareScrollView.tsx
...
const KeyboardAwareScrollView = ({
  ...
  const maybeScroll = useCallback(
    (e: number, animated = false) => {
      ...
      const point =
        (layout.value?.layout.absoluteY || 0) +
        (layout.value?.layout.height || 0);
