export default function Page() {
  return (
    <div className="container mx-auto p-4">
      <h1 className="my-2 text-3xl font-bold">Privacy Policy</h1>
      ...
      <h1 className="my-2 text-xl font-bold">Interpretation and Definitions</h1>
      <h2 className="my-1 text-lg">Interpretation</h2>
      <p>
      ...
      <h2 className="my-1 text-lg">Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong className="font-bold">Country</strong> refers to: United
            Kingdom
          </p>
        </li>
        <li>
          <p>
            <strong className="font-bold">Device</strong> means any device that
      ...
      <h2 className="my-1 text-lg">Types of Data Collected</h2>
      <h3 className="my-1">Personal Data</h3>
      <p>
      ...
      <h3 className="my-1">Usage Data</h3>
      ...
      <h2 className="my-1 text-lg">Use of Your Personal Data</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong className="font-bold">To manage Your Account:</strong> to
        ...
        <li>
          <p>
            <strong className="font-bold">To contact You:</strong> To contact
        ...
        <li>
          <p>
            <strong className="font-bold">To manage Your requests:</strong> To
        ...
        <li>
          <p>
            <strong className="font-bold">For other purposes</strong>: We may
      ...
      <ul>
        <li>
          <strong className="font-bold">With Service Providers:</strong> We may
          share Your personal information with Service Providers to monitor and
          analyze the use of our Service, to contact You.
        </li>
        <li>
          <strong className="font-bold">For business transfers:</strong> We may
        ...
        <li>
          <strong className="font-bold">With Affiliates:</strong> We may share
        ...
        <li>
          <strong className="font-bold">With business partners:</strong> We may
      ...
      <h2 className="my-1 text-lg">Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className="my-1 text-lg">Transfer of Your Personal Data</h2>
      <p>
      ...
      <h2 className="my-1 text-lg">Delete Your Personal Data</h2>
      <p>
      ...
      <h2 className="my-1 text-lg">Disclosure of Your Personal Data</h2>
      <h3 className="my-1">Business Transactions</h3>
      <p>
      ...
      <h3 className="my-1">Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="my-1">Other legal requirements</h3>
      <p>
      ...
      <h2 className="my-1 text-lg">Security of Your Personal Data</h2>
      <p>
      ...
      <h1 className="my-2 text-xl font-bold">Children&apos;s Privacy</h1>
      <p>
      ...
      <h1 className="my-2 text-xl font-bold">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="my-2 text-xl font-bold">Changes to this Privacy Policy</h1>
      <p>
